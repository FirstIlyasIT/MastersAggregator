...
internal class UserCreateViewModel : ViewModelBase
{
    ...
    public string? UserName { get => GetValue(_User.UserName); set => SetValue(value); }
    public string? UserFirstName { get => GetValue(_User.UserFirstName); set => SetValue(value); }
    public string? UserPfone { get => GetValue(_User.UserPfone); set => SetValue(value); }
    ...
    public void Commit()
    {
        if (UserName != "" && UserFirstName != "" && UserPfone != "")
        {
            var df = _Values["UserName"];
            ChengeValuesBool = true;
            _User.UserName = (string)_Values["UserName"];
            _User.UserFirstName = (string)_Values["UserFirstName"];
            _User.UserPfone = (string)_Values["UserPfone"];
        }
    }
    #endregion
}
